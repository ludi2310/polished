...
; ================
	...
	db 75, MEGANIUM, SITRUS_BERRY
		db GIGA_DRAIN, PROTECT, LEECH_SEED, TOXIC
	db 75, FERALIGATR, LUM_BERRY
		db WATERFALL, CRUNCH, ICE_PUNCH, DRAGONDANCE
	db 75, STEELIX, CHESTO_BERRY
		db IRON_TAIL, ROCK_SLIDE, EARTHQUAKE, REST
	db 75, WEAVILE, LEFTOVERS
		db CONFUSE_RAY, CURSE, FEINT_ATTACK, PROTECT
...
; ================
	...
	db 14, PIDGEOTTO, PECHA_BERRY, 16, SHINY MASK
...
; ================
	...
	db 18, SCYTHER, SITRUS_BERRY, 32, SHINY_MASK, HIDDEN_ABILITY | QUIRKY, FEMALE
...
; ================
	...
	db 23, MILTANK, LUM_BERRY, 48, SHINY MASK, HIDDEN_ABILITY | QUIRKY, FEMALE ; Scrappy
...
endc
	...
	db 28, GENGAR, WIDE_LENS, 64, SHINY MASK, HIDDEN_ABILITY | QUIRKY, MALE ; Levitate
...
endc
	...
	db 33, POLIWRATH, ZOOM_LENS, 80, SHINY MASK
...
; ================
	...
	db 36, SLOWBROW, NO_ITEM, 96
		db RAIN_DANCE, PSYCHIC, SURF, THUNDER_WAVE
	db 36, SCIZOR, NO_ITEM, 96
		db RAIN_DANCE, AERIAL_ACE, METAL_CLAW, SLASH
	db 39, STEELIX, LEFTOVERS, 96, SHINY MASK
...
; ================
	...
	db 43, ARTICUNO, NO_ITEM, 112, SHINY MASK
		db BLIZZARD, HAIL, WATER_PULSE, FLY
	db 42, LAPRAS, NO_ITEM, 112
		db SURF, CONFUSE_RAY, THUNDER_BOLT, ICE_BEAM
...
endc
	...
	db 49, KINGDRA, SHELL_BELL, 128, SHINY MASK, ABILITY_2 | QUIRKY, FEMALE ; Sniper
...
; ================
	...
	db 51, SLOWKING, SITRUS_BERRY, 144
		db SURF, CALM_MIND, ANCIENT_POWER, PSYCHIC_M
...
; ================
	...
	db 73, SLOWBRO, WISE_GLASSES, FAKE_PERFECT_DVS
...
; ================
	...
	db 63, ARBOK, SOFT_SAND, ABILITY_1 | QUIRKY, MALE | ARBOK_KOGA_FORM
...
; ================
	...
	db 53, SNORLAX, LEFTOVERS, 176
		db BODY_SLAM, REST, EARTHQUAKE, SLEEPTALK
...
; ================
	...
	db 62, PRIMEAPE, NO_ITEM, 160
		db CORSS_CHOP, EARTHQUAKE, ROCK_SLIDE, BODY_SLAM
...
; ================
	...
	db 90, LUGIA, LIFE_ORB, HIDDEN_ABILITY, SHINY_MASK | TIMID, MALE
		db CALM_MIND, AERO_BLAST, EARTH_POWER, ROOST
...
; ================
	...
	db 22, JOLTEON, NO_ITEM, 52
		db THUNDER_WAVE, THUNDER_BOLT, QUICK_ATTACK, MUD_SLAP
...
; ================
	...
	db 42, GENGAR, NO_ITEM, 116
		db THUNDER_BOLT, FOCUS_BLAST, CONFUSE_RAY, SHADOW_BALL
...
; ================
	...
	db TRAINERTYPE_ITEM | TRAINERTYPE_EVS | TRAINERTYPE_DVS | TRAINERTYPE_PERSONALITY | TRAINERTYPE_MOVES
	; party
	db 13, BELLSPROUT, MIRACLE_SEED, 20, $EE, $EE, $EE, ABILITY_1 | ADAMANT, MALE
		db VINE_WHIP, GROWTH, WRAP, SLEEP_POWDER
	db 13, ZUBAT, MIRACLE_SEED, 20, $EE, $EE, $EE, ABILITY_1 | RASH, MALE
		db GUST, ABSORB, ASTONISH, BITE
	db 16, BULBASAUR, MIRACLE_SEED, 20, $EE, $EE, $EE, ABILITY_2 | HASTY, MALE
...
; ================
	...
	db TRAINERTYPE_ITEM | TRAINERTYPE_PERSONALITY | TRAINERTYPE_MOVES
	; party
	db 45, HOUNDOUR, EVIOLITE, ABILITY_1 | QUIRKY, MALE
