...
; ================ 
	...
	; party
	db 77, HERACROSS, BLACK_BELT, ABILITY_1 | QUIRKY, MALE
		db MEGAHORN, CROSS_CHOP, ROCK_SMASH, STONE_EDGE
	db 75, LEDIAN, KINGS_ROCK, ABILITY_1 | QUIRKY, FEMALE
...
endc
	db 77, PARASECT, LEFTOVERS, ABILITY_1 | QUIRKY, MALE
		db SPORE, HEALINGLIGHT, SEED_BOMB, X_SCISSOR
	db 79, PINSIR, SCOPE_LENS, ABILITY_1 | QUIRKY, MALE
		db MEGAHORN, SWORDS_DANCE, CLOSE_COMBAT, EARTHQUAKE
	db 78, SCYTHER, EVIOLITE, ABILITY_1 | QUIRKY, FEMALE
...
; ================
	...
	db TRAINERTYPE_ITEM | TRAINERTYPE_PERSONALITY | TRAINERTYPE_MOVES
	; party
	db 77, CLEFABLE, PINK_BOW, ABILITY_1 | QUIRKY, FEMALE
	...
	db 77, WIGGLYTUFF, LEFTOVERS, ABILITY_1 | QUIRKY, FEMALE
		db FOCUS_BLAST, HYPER_VOICE, DAZZLINGLEAM, ICE_BEAM
	db 79, TAUROS, SILK_SCARF, ABILITY_1 | QUIRKY, FEMALE
		db BULK_UP, EARTHQUAKE, STRENGTH, IRON_TAIL
	db 79, MILTANK, BRIGHTPOWDER, ABILITY_2 | QUIRKY, FEMALE ; Scrappy
...
; ================
	...
	db TRAINERTYPE_ITEM | TRAINERTYPE_PERSONALITY | TRAINERTYPE_MOVES
	; party
	db 77, GENGAR, LEFTOVERS, ABILITY_2 | QUIRKY, MALE ; Levitate
	...
	db 76, MAROWAK, THICK_CLUB, ABILITY_1 | QUIRKY, MALE | ALOLAN_FORM
		db BONEMERANG, STONE_EDGE, ICE_PUNCH, SHADOW_CLAW
	db 77, MISMAGIUS, PINK_BOW, ABILITY_1 | QUIRKY, MALE
...
if DEF(FAITHFUL)
	...
	db 79, NOCTOWL, SHARP_BEAK, ABILITY_1 | QUIRKY, MALE
		db MOONBLAST, AIR_SLASH, SHADOW_BALL, REFLECT
endc
	db 80, GENGAR, SPELL_TAG, ABILITY_2 | QUIRKY, MALE ; Levitate
...
; ================
	...
	db 36, SCIZOR, NO_ITEM, 96
		db RAIN_DANCE, AERIAL_ACE, METAL_CLAW, SLASH
...
; ================
	...
	db TRAINERTYPE_ITEM | TRAINERTYPE_DVS | TRAINERTYPE_MOVES
	; party
	db 77, DEWGONG, FOCUS_BAND, FAKE_PERFECT_DVS
		db PROTECT, TOXIC, SURF, ICE_BEAM
	db 77, CLOYSTER, KINGS_ROCK, FAKE_PERFECT_DVS
		db SPIKES, SURF, EXPLOSION, ICICLE_CRASH
	db 78, WEAVILE, KINGS_ROCK, FAKE_PERFECT_DVS
		db SWORDS_DANCE, ICICLE_CRASH, SLASH, CRUNCH
	db 77, GLACEON, NEVERMELTICE, DVS_HP_GROUND
		db ICE_BEAM, HIDDEN_POWER, BARRIER, BATON_PASS ; HP Ground
	db 77, LAPRAS, LEFTOVERS, FAKE_PERFECT_DVS
		db SING, TOXIC, ICE_BEAM, THUNDERBOLT
	db 80, MAMOSWINE, HARD_STONE, FAKE_PERFECT_DVS
...
; ================
	...
	db TRAINERTYPE_ITEM | TRAINERTYPE_PERSONALITY | TRAINERTYPE_MOVES
	; party
	db 78, GYARADOS, BRIGHTPOWDER, ABILITY_1 | QUIRKY, FEMALE
		db DRAGON_DANCE, WATERFALL, FLY, EARTHQUAKE
	db 78, EXEGGUTOR, LUM_BERRY, HIDDEN_ABILITY | QUIRKY, FEMALE ; Harvest
		db REST, SLEEP_POWDER, GIGA_DRAIN, DRAGON_PULSE
	db 77, DRAGONITE, LEFTOVERS, ABILITY_1 | QUIRKY, FEMALE
		db OUTRAGE, EXTREMESPEED, FIRE_PUNCH, EARTHQUAKE
if DEF(FAITHFUL)
	db 77, DRAGONITE, DRAGON_FANG, ABILITY_1 | QUIRKY, FEMALE
		db DRAGON_DANCE, DRAGON_CLAW, WATERFALL, GIGA_IMPACT
else
	db 77, AMPHAROS, DRAGON_FANG, ABILITY_1 | QUIRKY, FEMALE
		db THUNDER_WAVE, CONFUSE_RAY, THUNDERBOLT, DRAGON_PULSE
endc
	db 78, DRAGONAIR, EVIOLITE, ABILITY_1 | QUIRKY, FEMALE
		db DRAGON_DANCE, EXTREMESPEED, OUTRAGE, AQUA_TAIL
	db 80, KINGDRA, CHESTO_BERRY, ABILITY_2 | QUIRKY, FEMALE ; Sniper
...
; ================
	...
	db TRAINERTYPE_ITEM | TRAINERTYPE_DVS | TRAINERTYPE_MOVES
	; party
	db 70, XATU, TWISTEDSPOON, FAKE_PERFECT_DVS
...
; ================
	...
	db 79, GYARADOS, LIFE_ORB, ABILITY_1 | JOLLY, MALE
		db DRAGON_DANCE, FLY, WATERFALL, EARTHQUAKE
	db 83, DRAGONITE, LEFTOVERS, HIDDEN_ABILITY | MODEST, MALE
...
endc
	db 85, DRAGONITE, WEAK_POLICY, SHINY_MASK | HIDDEN_ABILITY | ADAMANT, MALE
...
; ================
	...
	db 75, SUICUNE, LEFTOVERS, SHINY_MASK
		db CALM_MIND, ICE_BEAM, SURF, AIR_SLASH
...
; ================
	...
	db 75, RAIKOU, NEVERMELTICE, DVS_HP_ICE
...
endc
	...
	db 74, CELEBI, QUICK_CLAW, FAKE_PERFECT_DVS
...
; ================
	...
	db 90, CELEBI, TWISTEDSPOON, HIDDEN_ABILITY | MODEST, MALE
	...
	db 90, LUGIA, LIFE_ORB, HIDDEN_ABILITY | TIMID, MALE
		db CALM_MIND, PSYCHIC_M, EARTH_POWER, ROOST
	db 90, SUICUNE, LEFTOVERS | HIDDEN_ABILITY | TIMID, MALE
