...
; ================
	...
	db TRAINERTYPE_ITEM | TRAINERTYPE_DVS | TRAINERTYPE_MOVES
	; party
	db 69, XATU, TWISTEDSPOON, FAKE_PERFECT_DVS
		db AIR_SLASH, FUTURE_SIGHT, CONFUSE_RAY, PSYCHIC_M
	db 69, JYNX, BRIGHTPOWDER, FAKE_PERFECT_DVS
		db NASTY_PLOT, DRAIN_KISS, ICE_BEAM, PSYCHIC_M
	db 70, CELEBI, LEFTOVERS, FAKE_PERFECT_DVS
	...
	db 70, CLEFABLE, LEFTOVERS, FAKE_PERFECT_DVS
		db MOON_BLAST, RECOVER, FLAMETHROWER, CALM_MIND
	db -1 ; end
...
; ================
	...
	db TRAINERTYPE_ITEM | TRAINERTYPE_PERSONALITY | TRAINERTYPE_MOVES
	; party
	db 70, TENTACRUEL, WISE_GLASSES, ABILITY_1 | QUIRKY, MALE
		db RECOVER, ICE_BEAM, SURF, SLUDGE_BOMB
	db 71, ELECTRODE, DAMP_ROCK, ABILITY_1 | QUIRKY, MALE
		db RAIN_DANCE, THUNDER, THUNDER_WAVE, BUG_BUZZ
	db 70, ARBOK, SOFT_SAND, ABILITY_1 | QUIRKY, MALE | ARBOK_KOGA_FORM
		db SLUDGE_BOMB, GLARE, EARTHQUAKE, SCREECH
	db 70, LANTURN, LEFTOVERS, ABILITY_1 | QUIRKY, MALE
		db SURF, ICE_BEAM, CONFUSE_RAY, THUNDERBOLT
