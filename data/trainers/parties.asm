...
; ================
	...
	db 60, SLOWBRO, NO_ITEM, 144
		db PSYCHIC_M, SURF, EARTHQUAKE, THUNDERWAVE
...
; ================
	...
	db 90, ESPEON, TWISTEDSPOON, HIDDEN_ABILITY | MODEST, MALE
	...
	db 90, OMASTAR, WISE_GLASSES, HIDDEN_ABILITY | MODEST, MALE
		db SURF, ANCIENTPOWER, EARTH_POWER, ICE_BEAM
	db 90, GYARADOS, QUICK_CLAW, SHINY_MASK | HIDDEN_ABILITY | ADAMANT, MALE
