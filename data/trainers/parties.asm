...
; ================
	...
	db 37, AMPHAROS, NO_ITEM, 96
		db FIRE_PUNCH, THUNDERWAVE, THUNDERBOLT, IRON_TAIL
...
; ================
	...
	db 52, ELECTRODE, BRIGHTPOWDER, 160
		db DOUBLE_TEAM, EXPLOSION, THUNDERBOLT, THUNDERWAVE
...
; ================
	...
	db 30, ELECTRODE, MAGNET, FAKE_PERFECT_DVS, SHINY_MASK | HIDDEN_ABILITY | QUIRKY, MALE
		db THUNDER, THUNDERWAVE, SONIC_BOOM, LIGHT_SCREEN
