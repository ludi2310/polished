...
; ================
	...
	db 16, BEEDRILL, NO_ITEM, 32, ABILITY_1 | QUIRKY, MALE
		db POISON_STING, STRING_SHOT, SWORDS_DANCE, FURY_STRIKES
...
; ================
	...
	db 68, VENOMOTH, SITRUS_BERRY, 208
