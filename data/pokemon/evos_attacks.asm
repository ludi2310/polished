...
RaichuAlolanEvosAttacks:
	db 0 ; no more evolutions
	db 1, THUNDERSHOCK
	db 1, NASTY_PLOT ; Tail Whip → similar move
	db 1, QUICK_ATTACK
	db 1, THUNDERBOLT
...
PsyduckEvosAttacks:
	...
	db 7, WATER_GUN
	db 10, CONFUSION
	db 13, HYPNOSIS ; Fury Swipes → similar move
	db 16, WATER_PULSE
	db 19, CONFUSE_RAY
	db 22, SCREECH
	db 25, ZEN_HEADBUTT
...
ArcanineEvosAttacks:
	...
	db 40, FLAMETHROWER
	db 45, CRUNCH
	db 50, EXTREMESPEED ; evolution move
	db 0 ; no more level-up moves
...
KadabraEvosAttacks:
	...
	db 31, RECOVER
	db 33, FUTURE_SIGHT ; Telekinesis → egg move
...
RapidashPlainEvosAttacks:
	...
	db 25, FIRE_SPIN
	db 29, TAKE_DOWN
	db 33, AGILITY ; Inferno → egg move
	db 42, MEGAHORN
	db 44, FIRE_BLAST
	db 45, EXTREMESPEED ; Bounce → new move
	db 49, FLARE_BLITZ
...
HorseaEvosAttacks:
	...
	db 21, OCTAZOOKA ; Bubble Beam → TM move
	db 26, FOCUS_ENERGY
...
TaurosEvosAttacks:
	...
	db 29, SWORDS_DANCE ; Work Up → Let's Go move
	db 35, TAKE_DOWN
	db 41, ZEN_HEADBUTT
	db 48, SWAGGER
	db 55, THRASH
...
AriadosEvosAttacks:
	...
	db 15, NIGHT_SHADE
	db 19, GROWTH ; Shadow Sneak → event move
	db 23, PSYBEAM ; Fury Swipes → similar move
	db 28, SUCKER_PUNCH
	...
	db 46, PSYCHIC_M
	db 50, POISON_JAB
	db 55, MEGAHORN ; Cross Poison → TM move
...
XatuEvosAttacks:
	...
	db 43, DRILL_PECK ; Psycho Shift → egg move
	db 49, FUTURE_SIGHT
...
PinecoEvosAttacks:
	...
	db 1, TACKLE
	db 1, PROTECT
	db 6, TOXIC_SPIKES ; Self-Destruct → TCG move
	db 9, BUG_BITE
...
ShuckleEvosAttacks:
	...
	db 5, ENCORE
	db 9, WRAP
	db 12, KNOCK_OFF ; Struggle Bug → HGSS tutor move
	db 16, SAFEGUARD
	db 20, REST
	db 23, ROCK_THROW
...
SkarmoryEvosAttacks:
	...
	db 34, STEEL_WING
	db 39, SLASH
	db 42, DRILL_PECK ; Metal Sound → similar move
	db 45, AIR_SLASH
	db 50, BRAVE_BIRD ; Autotomize → egg move
	db 53, NIGHT_SLASH
	db 0 ; no more level-up moves
...
HitmontopEvosAttacks:
	...
	db 37, AGILITY
	db 42, GYRO_BALL
	db 46, EARTHQUAKE ; Wide Guard + Quick Guard → new move
	db 50, SUCKER_PUNCH ; Detect → similar move
	db 55, CLOSE_COMBAT
